...
| [Copilot context compaction](copilot-context-compaction.md) | 2026-09-04 | **Conditional go.** Native threshold compaction is available in tested builds; explicit `/compact` has no supported task-session target and is not invoked. |
